...
const data = [
  {
    ...
    image: "/ktgk01/asset/spy_card 1.png",
    episode: "01"
  },
  {
    id: "2",
    ...
    image: "/ktgk01/asset/One-piece 1.png",
    episode: "1018"
  },
  {
    id: "3",
    ...
    image: "/ktgk01/asset/boruto-naruto-next-generations 1.png",
    episode: "250"
  },
  {
    id: "4",
  ...
  },
  {
    ...
    image: "/ktgk01/asset/attackontitan 1.png",
    episode: "28"
  },
  {
    id: "6",
    ...
    image: "/ktgk01/asset/captsu_card 1.png",
    episode: "28"
  },
  {
    id: "7",
    ...
    image: "/ktgk01/asset/aoashi_card 1.png",
    episode: "28"
  }

]
function App() {
  const [HighLighs, setHighLighs] = useState("1")
  ...
  return (
    <>
      <div className='Home'>
        ...
        <div>
          <p style={{ color: '#868686', fontSize: '20px', margin: '0px' }}>What are you gonna watch today ?</p>
        </div>
        {data.filter((item) => item.id === HighLighs).map((Props) => (
          <Show
        ...
        <div className='NewRelease'>
          ...
          <div className='container'>
            {data.filter((item) => item.id !== "1").map((Props) =>
              <Movie
                image={Props.image}
                episode={Props.episode}
                movieName={Props.movieName}
                id={Props.id}
                onMovieClick={setHighLighs}
              />
            )}
          </div>
        </div>
